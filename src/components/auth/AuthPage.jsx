    ...
    <div className="h-screen w-screen overflow-hidden relative flex items-center justify-center">
      ...
      <AnimatePresence mode="wait">
        {!showAuth ? (
          <motion.div
            key="hero-content"
            className="relative z-10 flex flex-col items-center justify-center text-center px-6 max-w-[900px] w-full"
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -24 }}
            transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }}
          >
            {/* Small glassmorphism pill above heading */}
            <div
              className="flex items-center gap-2 px-3.5 py-1.5 bg-white/10 border border-white/20 mb-6 shrink-0"
              style={{ borderRadius: '20px' }}
            >
            ...
            {/* Heading with white-to-gray gradient text */}
            <h1
              className="text-[40px] md:text-[68px] font-semibold tracking-tight text-center leading-[1.1] mb-6 bg-gradient-to-b from-white to-white/50 bg-clip-text text-transparent"
            >
              Build What’s Next.
            </h1>

            {/* Subtitle */}
            <p className="text-[15px] md:text-[18px] text-gray-400 leading-relaxed text-center max-w-[700px] mx-auto mb-8 font-normal">
              From architecture to deployment, Euler helps you turn ideas into software.
            </p>
            ...
            <div className="flex flex-col items-center gap-4">
              <motion.button
                ...
                className="px-8 py-3 bg-white text-black font-semibold rounded-full text-[14px] tracking-tight transition-all shadow-[0_0_24px_rgba(255,255,255,0.25)] hover:shadow-[0_0_35px_rgba(255,255,255,0.4)]"
              ...
              <p className="text-[12px] text-gray-500">
                ...
                <span
                  onClick={() => { setTab('signin'); setShowAuth(true); }}
